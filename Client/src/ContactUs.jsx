...
const ContactUs = () => {
    ...
    <div>
            ...
            <div className="container-fluid">
                <div className="col-md-3 mb-2 mb-md-0">
                    <a href="/" className="d-inline-flex link-body-emphasis text-decoration-none">
                        <svg className="bi mx-3 me-2" width="40" height="32" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                ...
                <div className="collapse navbar-collapse" id="navbarsExample04">
                    <ul className="navbar-nav me-auto mb-2 mb-md-0">
                        <li className="nav-item me-3">
                            <a className="nav-link link-dark" aria-current="page" href="/Home2">Home</a>
                        </li>
                        <li className="nav-item me-3">
        ...
        <div className='align'>
            <div className="container card shadow p-2 p-md-5 mt-2">
                <h2 className="text-center mb-4">Contact Us</h2>
                <div className="row align-items-center g-4">
                <div className="col-lg-6   text-center text-lg-start mb-4 mb-lg-0">
                        <img src={image} className="img-fluid" alt="Contact" />
                </div>
