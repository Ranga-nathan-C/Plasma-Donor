    ...
    <div className="bg1">
      ...
      <div className=" text-center  pt-5  pb-5">
        <div className="container">
          ...
          <p className="lead ">
            Your donation can save up to three lives. Be a hero, donate today!
          </p>
          <div className="row">
              ...
              <div className="row text-center g-4">
                ...
                <div className="col-md-4">
                  <div className="p-4 border rounded bg-white h-100 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <p className="text-sm">
                      Supporting treatment for various conditions
                    </p>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="p-4 border rounded bg-white h-100 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <p className="text-sm">
                      Join our community of life-savers and donate blood
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="container pb-5  mt-5">
        <h1 className="text-center mb-4" id="Donate">
          Donate Blood & Plasma
        </h1>
        ...
        <div className="card mb-4 ">
          ...
          <div className="card-body">
            <ol className="list-group list-group-numbered">
              ...
              <li className="list-group-item">
                Blood or plasma donation (10-15 minutes for blood, up to 2 hours
                for plasma)
              </li>
        ...
        <div className="card ">
          <div className="card-header bg-info text-white">What to Expect</div>
          <div className="card-body">
            <p className="card-text">
              Donating blood or plasma is a safe and simple process. You may
              feel a slight pinch when the needle is inserted, but the
              discomfort is minimal and brief. After donating, its important to
              rest for a few minutes and enjoy some refreshments. Drink plenty
              of fluids and avoid strenuous activities for the rest of the day.
            </p>
            <p className="card-text">
