        ...
        <div className="col-md-3 mb-2 mb-md-0">
            ...
            >
                ...
                <div className="collapse navbar-collapse" id="navbarsExample04">
                    ...
                    <a  href="/Home2" className="btn btn-primary btn-sm px-4 login  w-30 h-30 me-md-2   fw-bold" >Login</a>
                    <a  href="/Signup" className="btn btn-primary btn-sm px-4  w-30 h-30 me-md-2  fw-bold" >Sign up</a>
                    </form>
                </div>
                </div>
            </nav> 
            <div className="modal bg1  modal-sheet  position-static d-block " tabIndex="-1" role="dialog" id="modalSignin">
            ...
            <div className="modal-dialog mb-5 pb-5" role="document">
                ...
                <div className="modal-body p-5 pt-0">
                    ...
                    <div className="form-floating mb-3">
                        <input type="text" className="form-control rounded-3" id="floatingInput" placeholder="Name" />
                    ...
                    <a href="/Home2" className="w-100 mb-2 btn btn-lg rounded-3 btn-primary" type="submit" >Sign up</a>
                    </form>
                </div>
                </div>
            </div>
